...
public enum ApiResultError {
    ...
    DELIVERY_NOT_EXIST_ARRIVAL_HUB("4301", "출발허브정보가 존재하지 않습니다."),
    DELIVERY_NOT_AVAILABLE_ARRIVAL_HUB("4302", "출발허브가 유효하지 않습니다."),
    DELIVERY_NOT_EXIST_DEPARTURE_HUB("4303", "도착허브정보가 존재하지 않습니다."),
    DELIVERY_NOT_AVAILABLE_DEPARTURE_HUB("4304", "도착허브가 유요하지 않습니다."),
